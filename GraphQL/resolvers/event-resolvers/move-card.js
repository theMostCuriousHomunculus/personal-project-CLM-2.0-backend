...
export default async function (parent, args, context, info) {
  ...
  const originCardsClone = [...player[origin]];
  const indexOfCard = originCardsClone.findIndex(card => card._id === cardID);
  ...
  const destinationCardsClone = [...player[destination]].concat(cardToMove);
